GameData = {
   monsters = {
      ["City Guard (Sun Special)"] = {
         name = "City Guard",
         internal = "City Guard (Sun Special)",
         maxInstances = 6,
         deck = "City Guard (Sun Special)",
         levels = {
            {
               normal = {
                  hp = "5",
      ...
      ["Inox Necromancer"] = {
         name = "Inox Necromancer",
         internal = "Inox Necromancer",
         maxInstances = 4,
         deck = "Inox Necromancer",
         levels = {
            {
               boss = {
                  hp = "6",
      ...
      ["Giant Viper (Angry Face Special)"] = {
         name = "Giant Viper",
         internal = "Giant Viper (Angry Face Special)",
         maxInstances = 10,
         deck = "Giant Viper",
         levels = {
            {
      ...
      ["Bandit Archer (Note Special)"] = {
         name = "Bandit Archer",
         internal = "Bandit Archer (Note Special)",
         maxInstances = 6,
         deck = "Bandit Archer (Note Special)",
         levels = {
            {
               normal = {
                  hp = "4",
      ...
      ["City Guard (Banner Spear Special)"] = {
         name = "City Guard",
         internal = "City Guard (Banner Spear Special)",
         maxInstances = 6,
         deck = "City Guard (Banner Spear Special)",
         levels = {
            {
               normal = {
                  hp = "5",
      ...
      ["Shape Blocks Out the Sun"] = {
         name = "Shape Blocks Out the Sun",
         internal = "Shape Blocks Out the Sun",
         maxInstances = 4,
         deck = "Lurker Clawcrusher",
         levels = {
            {
               boss = {
                  hp = "30",
      ...
      ["Earth Demon (Mindthief Special)"] = {
         name = "Earth Demon",
         internal = "Earth Demon (Mindthief Special)",
         maxInstances = 6,
         deck = "Earth Demon",
         levels = {
            {
      ...
      ["Algox Icespeaker (Shattersong Special)"] = {
         name = "Algox Icespeaker",
         internal = "Algox Icespeaker (Shattersong Special)",
         maxInstances = 4,
         deck = "Algox Icespeaker",
         levels = {
            {
               normal = {
                  hp = "6",
      ...
      ["Bandit Guard (Note Special)"] = {
         name = "Bandit Guard",
         internal = "Bandit Guard (Note Special)",
         maxInstances = 6,
         deck = "Bandit Guard (Note Special)",
         levels = {
            {
               normal = {
                  hp = "5",
      ...
      ["Earth Demon (Diviner Special)"] = {
         name = "Earth Demon",
         internal = "Earth Demon (Diviner Special)",
         maxInstances = 6,
         deck = "Earth Demon",
         levels = {
            {
      ...
      ["Stone Golem (Scoundrel Special)"] = {
         name = "Stone Golem",
         internal = "Stone Golem (Scoundrel Special)",
         maxInstances = 6,
         deck = "Stone Golem",
         levels = {
            {
      ...
      ["Black Imp (Deathwalker Special)"] = {
         name = "Black Imp",
         internal = "Black Imp (Deathwalker Special)",
         maxInstances = 10,
         deck = "Imp (FH)",
         levels = {
            {
      ...
      ["Energized Corpse"] = {
         name = "Energized Corpse",
         internal = "Energized Corpse",
         maxInstances = 6,
         deck = "Frozen Corpse",
         levels = {
            {
      ...
      ["Chief of Spikes"] = {
         name = "Chief of Spikes",
         internal = "Chief of Spikes",
         maxInstances = 4,
         deck = "Algox Icespeaker",
         levels = {
            {
      ...
      ["Plea for Help Without Answer"] = {
         name = "Plea for Help Without Answer",
         internal = "Plea for Help Without Answer",
         maxInstances = 6,
         deck = "Lurker Mindsnipper",
         levels = {
            {
               boss = {
                  hp = "21",
      ...
      ["Incarnation of Ancestors"] = {
         ...
         internal = "Incarnation of Ancestors",
         maxInstances = 6,
         deck = "Boss (FH)",
         levels = {
            {
      ...
      ["Cave Bear (Circles special)"] = {
         name = "Cave Bear",
         internal = "Cave Bear (Circles special)",
         maxInstances = 4,
         deck = "Cave Bear",
         levels = {
            {
      ...
      ["Lost in Seaweed"] = {
         name = "Lost in Seaweed",
         internal = "Lost in Seaweed",
         maxInstances = 6,
         deck = "Lurker Wavethrower",
         levels = {
            {
               boss = {
                  hp = "12",
      ...
      ["Night Demon (Deathwalker Special)"] = {
         name = "Night Demon",
         internal = "Night Demon (Deathwalker Special)",
         maxInstances = 6,
         deck = "Night Demon (FH)",
         levels = {
            {
      ...
      ["City Guard (Scoundrel Special)"] = {
         name = "City Guard",
         internal = "City Guard (Scoundrel Special)",
         maxInstances = 6,
         deck = "Guard",
         levels = {
            {
      ...
      ["Algox Snowspeaker (Trapper Special)"] = {
         name = "Algox Snowspeaker",
         internal = "Algox Snowspeaker (Trapper Special)",
         maxInstances = 4,
         deck = "Algox Snowspeaker (Trapper Special)",
         levels = {
            {
               normal = {
                  hp = "6",
      ...
      ["City Guard (Ally)"] = {
         name = "City Guard (Ally)",
         internal = "City Guard (Ally)",
         maxInstances = 6,
         deck = "Guard",
         levels = {
            {
      ...
      ["Large Vermling Scout"] = {
         name = "Large Vermling Scout",
         internal = "Large Vermling Scout",
         maxInstances = 10,
         deck = "Scout",
         levels = {
            {
      ...
      ["Living Spirit (FH)"] = {
         name = "Living Spirit",
         internal = "Living Spirit (FH)",
         maxInstances = 10,
         deck = "Living Spirit (FH)",
         levels = {
            {
               normal = {
                  hp = "2",
      ...
      ["Lurker Wavethrower Scenario 128"] = {
         ...
         internal = "Lurker Wavethrower Scenario 128",
         maxInstances = 6,
      ...
      ["Steel Automaton Scenario 128"] = {
         name = "Steel Automaton",
         internal = "Steel Automaton Scenario 128",
         maxInstances = 6,
         deck = "Imp (FH)",
         levels = {
            {
      ...
      ["Harrower Infester (FH)"] = {
         name = "Harrower Infester",
         internal = "Harrower Infester (FH)",
         maxInstances = 4,
         deck = "Harrower Infester (FH)",
         levels = {
            {
               normal = {
                  hp = "6",
      ...
      ["Spitting Drake (FH)"] = {
         name = "Spitting Drake",
         internal = "Spitting Drake (FH)",
         maxInstances = 6,
         deck = "Spitting Drake (FH)",
         levels = {
            {
               normal = {
                  hp = "4",
      ...
      ["Steel Automaton"] = {
         name = "Steel Automaton",
         internal = "Steel Automaton",
         maxInstances = 6,
         deck = "Steel Automaton",
         levels = {
            {
               normal = {
                  hp = "9",
      ...
      ["Flaming Sword of Justice"] = {
         ...
         internal = "Flaming Sword of Justice",
         maxInstances = 6,
         deck = "Guard (FH)",
         levels = {
            {
      ...
      ["Algox Snowspeaker"] = {
         name = "Algox Snowspeaker",
         internal = "Algox Snowspeaker",
         maxInstances = 4,
         deck = "Algox Snowspeaker",
         levels = {
            {
               normal = {
                  hp = "6",
      ...
      ["Savvas Icestorm (FH)"] = {
         ...
         internal = "Savvas Icestorm (FH)",
         maxInstances = 4,
         deck = "Savvas Icestorm (FH)",
         levels = {
            {
               normal = {
                  hp = "7",
      ...
      ["Burrowing Blade"] = {
         ...
         internal = "Burrowing Blade",
         maxInstances = 6,
         deck = "Burrowing Blade",
         levels = {
            {
               normal = {
                  hp = "4",
      ...
      ["Steel Automaton Scenario 134"] = {
         name = "Steel Automaton",
         internal = "Steel Automaton Scenario 134",
         maxInstances = 6,
         deck = "Steel Automaton",
         levels = {
            {
      ...
      ["Vestige of the Imprisoned God"] = {
         ...
         internal = "Vestige of the Imprisoned God",
         maxInstances = 1,
         deck = "Boss (FH)",
         levels = {
            {
      ...
      ["Lurker Wavethrower Scenario 131"] = {
         name = "Lurker Wavethrower",
         internal = "Lurker Wavethrower Scenario 131",
         maxInstances = 6,
         deck = "Lurker Wavethrower Scenario 131",
         levels = {
            {
               normal = {
                  hp = "4",
      ...
      ["Living Bones (FH)"] = {
         name = "Living Bones",
         internal = "Living Bones (FH)",
         maxInstances = 6,
         deck = "Living Bones (FH)",
         levels = {
            {
               normal = {
                  hp = "5",
      ...
      ["Rending Drake (FH)"] = {
         name = "Rending Drake",
         internal = "Rending Drake (FH)",
         maxInstances = 6,
         deck = "Rending Drake (FH)",
         levels = {
            {
               normal = {
                  hp = "5",
      ...
      ["Robotic Boltshooter"] = {
         ...
         internal = "Robotic Boltshooter",
         maxInstances = 6,
         deck = "Robotic Boltshooter",
         levels = {
            {
               normal = {
                  hp = "4",
      ...
      ["City Guard Scenario 1"] = {
         name = "City Guard",
         internal = "City Guard Scenario 1",
         maxInstances = 6,
      ...
      ["Lurker Conductor"] = {
         name = "Lurker Conductor",
         internal = "Lurker Conductor",
         maxInstances = 4,
         deck = "Lurker Clawcrusher",
         levels = {
            {
      ...
      ["Laser Spire Controller"] = {
         name = "Laser Spire Controller",
         internal = "Laser Spire Controller",
         maxInstances = 1,
         deck = "Laser Spire",
         levels = {
            {
      ...
      ["Hound Scenario 0"] = {
         name = "Hound",
         internal = "Hound Scenario 0",
         maxInstances = 6,
         deck = "Hound Scenario 0",
         levels = {
            {
               normal = {
                  hp = "4",
      ...
      ["Augmented Mindthief"] = {
         name = "Augmented Mindthief",
         internal = "Augmented Mindthief",
         maxInstances = 6,
         deck = "Steel Automaton",
         levels = {
            {
      ...
      ["Savvas Lavaflow (FH)"] = {
         ...
         internal = "Savvas Lavaflow (FH)",
         maxInstances = 4,
         deck = "Savvas Lavaflow (FH)",
         levels = {
            {
               normal = {
                  hp = "8",
      ...
      ["Ancient Artillery (FH)"] = {
         ...
         internal = "Ancient Artillery (FH)",
         maxInstances = 6,
         deck = "Ancient Artillery (FH)",
         levels = {
            {
               normal = {
                  hp = "4",
      ...
      ["Giant Piranha Pig Water"] = {
         name = "Giant Piranha Pig Water",
         internal = "Giant Piranha Pig Water",
         maxInstances = 1,
         deck = "Boss (FH)",
         levels = {
            {
      ...
      ["Flaming Bladespinner"] = {
         ...
         internal = "Flaming Bladespinner",
         maxInstances = 6,
         deck = "Flaming Bladespinner",
         levels = {
            {
               normal = {
                  hp = "6",
   ...
   decks = {
      ...
      ["Bandit Guard (Note Special)"] = {
         name = "Bandit Guard (Note Special)",
         cards = {
            {
               0,
               true,
      ...
      ["Bandit Archer (Note Special)"] = {
         name = "Bandit Archer (Note Special)",
         cards = {
            {
               0,
               true,
      ...
      ["City Guard (Banner Spear Special)"] = {
         name = "City Guard (Banner Spear Special)",
         cards = {
            {
               0,
               true,
      ...
      ["Algox Snowspeaker (Trapper Special)"] = {
         name = "Algox Snowspeaker (Trapper Special)",
         cards = {
            {
               738,
               false,
   ...
   scenarios = {
      ["#30 Pain Conduit: A Collection of Suffering"] = {
         name = "#30 Pain Conduit: A Collection of Suffering",
         monsters = {
            "Chaos Demon (FH)",
            "Earth Demon (FH)",
            "Flame Demon (FH)",
         ...
         specials = {
            {
               ...
               name = "spawn 1",
               startOfRound = true,
               note = "Spawn one normal Flame Demon at A.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 2",
               startOfRound = true,
               note = "Spawn one normal Sun Demon at B.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 3",
               startOfRound = true,
               note = "Spawn one normal Earth Demon A.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 4",
               startOfRound = true,
               note = "Spawn one normal Chaos Demon at B.",
               },
            },
         },
      ["#17 Beast Tyrant: The Caged Bear"] = {
         name = "#17 Beast Tyrant: The Caged Bear",
         monsters = {
            "Hound",
            "Forest Imp",
            "Rending Drake",
      ...
      ["#43 Hollowpact: Hallow Redemption"] = {
         name = "#43 Hollowpact: Hallow Redemption",
         monsters = {
            "Aesther Ashblade",
            "Cave Bear",
            "Forest Imp",
      ...
      ["#38 Brightspark: Elemental Converter"] = {
         name = "#38 Brightspark: Elemental Converter",
         monsters = {
            "Black Imp",
            "Deep Terror",
            "Hound",
      ...
      ["#35 Deepwraith: Wet Work"] = {
         name = "#35 Deepwraith: Wet Work",
         monsters = {
            "Abael Warlord",
            "Abael Scout",
            "Burrowing Blade",
      ...
      ["#41 Fire Knight: Through the Fire and the Flames"] = {
         name = "#41 Fire Knight: Through the Fire and the Flames",
         monsters = {
            "Flame Demon",
            "Rending Drake #60 Special",
            "Savvas Lavaflow",
            "Spitting Drake",
            },
         specials = {
      ...
      ["#29 Trapper: A Magnificent Trap"] = {
         name = "#29 Trapper: A Magnificent Trap",
         monsters = {
            "Algox Guard",
            "Algox Snowspeaker (Trapper Special)",
            "Wind Demon (FH)",
         ...
         specials = {
            {
               ...
               name = "spawn 1",
               startOfRound = true,
               note = "Spawn one normal Algox Guard at C.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 2",
               startOfRound = true,
               note = "Spawn one normal Wind Demon at A.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 3",
               startOfRound = true,
               note = "Spawn one normal Algox Snowspeaker at B and one normal Algox Guard at C.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 4",
               startOfRound = true,
               note = "Spawn one normal Algox Snowspeaker at B.",
               },
            },
         },
      ["#8 Quartermaster: Storage Fees"] = {
         name = "#8 Quartermaster: Storage Fees",
         monsters = {
            "Hound",
            "Bandit Guard",
            "Bandit Archer",
      ...
      ["#40 Chieftain: Forest Invaders"] = {
         name = "#40 Chieftain: Forest Invaders",
         monsters = {
            "Cave Bear",
            "Giant Viper",
            "Hound",
      ...
      ["#15 Sawbones: Aftermath"] = {
         name = "#15 Sawbones: Aftermath",
         monsters = {
            "City Guard",
            "Lieutenant",
            },
         ...
         specials = {
            {
               ...
               name = "spawn 1",
               startOfRound = true,
               note = "Spawn normal Living Bones at D.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 1",
               startOfRound = true,
               note = "Spawn normal Living Bones at E.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 2",
               startOfRound = true,
               note = "Spawn normal Living Spirit at B and C.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 3",
               startOfRound = true,
               note = "Spawn normal Frozen Corpse at D.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 3",
               startOfRound = true,
               note = "Spawn normal Frozen Corpse at E.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 4",
               startOfRound = true,
               note = "Spawn normal Living Bones at D and E.",
               },
            {
               type = "Timer",
               list = {
      ...
      ["#39 Chainguard: Penitentiary Lockdown"] = {
         name = "#39 Chainguard: Penitentiary Lockdown",
         monsters = {
            "Bandit Archer",
            "Bandit Guard",
            },
      ...
      ["#9 Summoner: Plane of Wild Beasts"] = {
         name = "#9 Summoner: Plane of Wild Beasts",
         monsters = {
            "Hound",
            "Spitting Drake",
            "Cave Bear (Circles special)",
         ...
         specials = {
            {
               ...
               name = "spawn 1",
               startOfRound = false,
               note = "One normal Hound spawns at A.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 2",
               startOfRound = false,
               note = "One normal Spitting Drake spawns at B.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 3",
               startOfRound = false,
               note = "Two normal Hounds spawns at C.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 4",
               startOfRound = false,
               note = "One normal Spitting Drake spawns at D.",
               },
            },
         },
      ["#26 Infuser: Path of Ancestry"] = {
         name = "#26 Infuser: Path of Ancestry",
         monsters = {
            "Incarnation of Ancestors",
            },
         loot = {
         ...
         specials = {
            {
               type = "Objective",
               name = "Orb of Energy a",
               hp = "L+1",
               },
            {
               type = "Objective",
               name = "Orb of Energy b",
               hp = "L+1",
               },
            {
               type = "Objective",
               name = "Orb of Energy c",
               hp = "L+1",
               },
            {
               type = "Objective",
               name = "Orb of Energy d",
               hp = "L+1",
               },
            {
               type = "Timer",
               ...
               startOfRound = true,
               note = "Altar 1 spawns Orb of Energy a",
               },
            {
               type = "Timer",
               list = {
               ...
               startOfRound = true,
               note = "Altar 2 spawns Orb of Energy b",
               },
            {
               type = "Timer",
               list = {
               ...
               startOfRound = true,
               note = "Altar 3 spawns Orb of Energy c",
               },
            {
               type = "Timer",
               list = {
               ...
               startOfRound = true,
               note = "Altar 4 spawns Orb of Energy d",
               },
            },
         },
      ["#19 Diviner: Forecast of the Inevitable"] = {
         name = "#19 Diviner: Forecast of the Inevitable",
         monsters = {
            "Earth Demon (Diviner Special)",
            "Valrath Savage",
            },
      ...
      ["#49 Artificer: Magnum Opus"] = {
         name = "#49 Artificer: Magnum Opus",
         monsters = {
            "Clockwork Soldier",
            "Clockwork Railcaster",
            },
         specials = {
            {
               type = "Timer",
               ...
               },
            {
               ...
               startOfRound = true,
               note = "Add Section QA2.",
               },
            },
         sections = {
            ["#2 Mechanical Menace"] = {
               name = "#2 Mechanical Menace",
               monsters = {
                  "Clockwork Devastator",
                  },
               specials = {
                  },
               },
      ...
      ["#46 Spirit Caller: Beyond the Grave"] = {
         name = "#46 Spirit Caller: Beyond the Grave",
         monsters = {
            "Vermling Shaman",
            },
         specials = {
         ...
         sections = {
            ...
            ["#73D Scenario 65"] = {
               name = "#73D Scenario 65",
               monsters = {
                  },
               specials = {
                  {
                     type = "Objective",
                     name = "Haunted Ghoul Spirit 1",
                     hp = "10",
                     init = 50,
                     },
                  },
      ...
      ["#52 Rimehearth: Conflux of Power"] = {
         name = "#52 Rimehearth: Conflux of Power",
         monsters = {
            "Savvas Acolyte",
            "Inferno Demon",
            "Glacier Demon",
      ...
      ["#25 Geminate: Divide and Conquer"] = {
         name = "#25 Geminate: Divide and Conquer",
         monsters = {
            "Flaming Bladespinner",
            "Ice Wraith",
            "Lightning Eel",
      ...
      ["#36 Crashing Tide: Crash Against the Waves"] = {
         name = "#36 Crashing Tide: Crash Against the Waves",
         monsters = {
            "Lightning Eel",
            "Lost in Seaweed",
            "Shape Blocks Out the Sun",
         ...
         specials = {
            {
               ...
               name = "spawn 1",
               startOfRound = true,
               note = "Spawn Lost in Seaweed at A and Lightning Eels each hex adjacent to it.",
               },
            },
         sections = {
            ["1"] = {
               ...
               specials = {
                     ...
                     },
                  {
                     ...
                     name = "spawn 2",
                     startOfRound = true,
                     note = "Spawn Shape BLocke Out the Sun",
                     },
                  },
               },
            ["2"] = {
               ...
               specials = {
                     ...
                     },
                  {
                     ...
                     name = "spawn 3",
                     startOfRound = true,
                     note = "Spawn Plea for Help Without Answer",
                     },
                  },
               },
            },
         },
      ["#11 Plagueherald: Plagued Crypt"] = {
         name = "#11 Plagueherald: Plagued Crypt",
         monsters = {
            "Giant Viper",
            "Black Imp",
            },
         specials = {
            {
               type = "Escort",
               name = "Spirit of Xorn 1",
               hp = "4+L",
               },
            {
               type = "Escort",
               name = "Spirit of Xorn 2",
               hp = "4+L",
               },
            {
               type = "Escort",
               name = "Spirit of Xorn 3",
               hp = "4+L",
               },
            {
               type = "Escort",
               name = "Spirit of Xorn 4",
               hp = "4+L",
               },
            {
               type = "Escort",
               name = "Spirit of Xorn 5",
               hp = "4+L",
               },
            {
               type = "Escort",
               name = "Spirit of Xorn 6",
               hp = "4+L",
               },
            {
               type = "Timer",
      ...
      ["#55 Thornreaper: Collapsed Cavern"] = {
         name = "#55 Thornreaper: Collapsed Cavern",
         monsters = {
            "Black Imp",
            "Cave Bear",
            "Deep Terror",
         ...
         specials = {
               ...
               },
            {
               ...
               startOfRound = false,
               note = "Read section 48.C",
               },
            },
         },
      ["#7 Sunkeeper: Caravan Escort"] = {
         name = "#7 Sunkeeper: Caravan Escort",
         monsters = {
            "City Guard (Sun Special)",
            "Bandit Guard",
            "Bandit Archer",
      ...
      ["#2 Tinkerer: An Unfortunate Intrusion"] = {
         name = "#2 Tinkerer: An Unfortunate Intrusion",
         monsters = {
            "City Guard (Ally)",
            "Vermling Scout",
            "Vermling Shaman",
         ...
         specials = {
            {
               ...
               name = "spawn 1",
               startOfRound = false,
               note = "Four normal Vermling Scouts spawn at A.",
               },
            },
         },
      ["#50 Ruinmaw: The Fall of Shadow’s Respite"] = {
         name = "#50 Ruinmaw: The Fall of Shadow’s Respite",
         monsters = {
            "Gnashing Drake",
            "Spitting Drake",
            "Rending Drake",
            "Vermling Scout (ally)",
            "Vermling Shaman (ally)",
            },
         specials = {
            {
               type = "Timer",
      ...
      ["#4 Scoundrel: Armory Heist"] = {
         name = "#4 Scoundrel: Armory Heist",
         monsters = {
            "City Guard (Scoundrel Special)",
            "Stone Golem (Scoundrel Special)",
            "Ancient Artillery",
      ...
      ["#12 Berserker: Unnatural Insults"] = {
         name = "#12 Berserker: Unnatural Insults",
         monsters = {
            "Living Corpse",
            "Living Bones",
            "Cultist",
      ...
      ["#20 Drifter: Wonder of Nature"] = {
         name = "#20 Drifter: Wonder of Nature",
         monsters = {
            "Flame Demon (FH)",
            "Forest Imp (FH)",
            "Hound (FH)",
      ...
      ["#54 Tempest: Storm Mountain"] = {
         name = "#54 Tempest: Storm Mountain",
         monsters = {
            "Stone Golem",
            "Volt Demon",
            "Wind Demon",
      ...
      ["#51 Incarnate: Unsouled"] = {
         name = "#51 Incarnate: Unsouled",
         monsters = {
            "Inox Archer",
            "Inox Guard",
            "Inox Guard (ally)",
      ...
      ["#24 Boneshaper: Bones in the Dirt"] = {
         name = "#24 Boneshaper: Bones in the Dirt",
         monsters = {
            "Earth Demon (FH)",
            "Snow Imp",
            "Hollow Scholar",
      ...
      ["#13 Soothsinger: Battle of the Bards"] = {
         name = "#13 Soothsinger: Battle of the Bards",
         monsters = {
            "Bandit Guard (Note Special)",
            "Bandit Archer (Note Special)",
            "City Guard",
      ...
      ["#31 Snowdancer: Fighting Snow with Snow"] = {
         name = "#31 Snowdancer: Fighting Snow with Snow",
         monsters = {
            "Algox Snowspeaker",
            "Frost Demon (FH)",
            "Wind Demon (FH)",
         ...
         specials = {
               ...
               },
            {
               ...
               name = "spawn 1",
               startOfRound = true,
               note = "Spawn one elite Frost Demon at E.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 2",
               startOfRound = true,
               note = "Spawn one normal Wind Demon at both D.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 3",
               startOfRound = true,
               note = "Spawn one elite Algox Snowspeaker at E.",
               },
            },
         },
      ["#47 Starslinger: Otherworldly Strangers"] = {
         name = "#47 Starslinger: Otherworldly Strangers",
         monsters = {
            "City Archer",
            "City Guard",
            "Earth Demon",
         ...
         specials = {
               ...
               },
            {
               ...
               startOfRound = false,
               note = "Read section 74F.",
               },
            },
         },
      ["#32 Frozen Fist: Under the Ice"] = {
         name = "#32 Frozen Fist: Under the Ice",
         monsters = {
            "Ancient Artillery (FH)",
            "Flaming Bladespinner",
            "Ruined Machine",
            ...
            ["1"] = {
               ...
               specials = {
                     ...
                     },
                  {
                     ...
                     name = "spawn 1",
                     startOfRound = true,
                     note = "Spawn normal Ruined Machines at A and B.",
                     },
                  {
                     type = "Timer",
                     list = {
                     ...
                     name = "spawn 2",
                     startOfRound = true,
                     note = "Spawn normal Ancient Artillery at C.",
                     },
                  {
                     type = "Timer",
                     list = {
                     ...
                     name = "spawn 2",
                     startOfRound = true,
                     note = "Spawn normal Ancient Artillery at D.",
                     },
                  {
                     type = "Timer",
                     list = {
                     ...
                     name = "spawn 3",
                     startOfRound = true,
                     note = "Spawn elite Flaming Bladespinner at A.",
                     },
                  {
                     type = "Timer",
                     list = {
                     ...
                     name = "spawn 4",
                     startOfRound = true,
                     note = "Spawn normal Ruined Machine at C.",
                     },
                  {
                     type = "Timer",
                     list = {
                     ...
                     name = "spawn 4",
                     startOfRound = true,
                     note = "Spawn normal Ruined Machine at D.",
                     },
                  {
                     type = "Timer",
                     list = {
                     ...
                     name = "spawn 5",
                     startOfRound = true,
                     note = "Spawn normal Ancient Artillery at A and B.",
                     },
                  },
               },
            },
         },
      ["#27 Pyroclast: Crumbling Descent"] = {
         name = "#27 Pyroclast: Crumbling Descent",
         monsters = {
            "Burrowing Blade",
            "Rending Drake (FH)",
            "Mountain's Heart",
      ...
      ["#14 Doomstalker: Corrupted Hunt"] = {
         name = "#14 Doomstalker: Corrupted Hunt",
         monsters = {
            "Ghost Wolf",
            "Deep Earth",
            "High Flame",
      ...
      ["#22 Banner Spear: Scouting Ambush"] = {
         name = "#22 Banner Spear: Scouting Ambush",
         monsters = {
            "City Guard (Banner Spear Special)",
            "Polar Bear",
            "Vermling Scout (FH)",
         ...
         specials = {
               ...
               },
            {
               ...
               name = "spawn 1",
               startOfRound = true,
               note = "Spawn normal Vermling Scout at B, C, D, E.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 2",
               startOfRound = true,
               note = "Spawn normal Polar Bear at B. Elite Vermling Scout at D and F.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 3",
               startOfRound = true,
               note = "Spawn elite Vermling Scout at A, B, C.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 4",
               startOfRound = true,
               note = "Spawn elite Polar Bear at E. Elite Vermling Scout at D and F.",
               },
            },
         },
      ["#45 Luminary: Glowing Crystals"] = {
         name = "#45 Luminary: Glowing Crystals",
         monsters = {
            "Deep Terror",
            "Lurker",
            },
      ...
      ["#16 Elementalist: Elemental Secrets"] = {
         name = "#16 Elementalist: Elemental Secrets",
         monsters = {
            "Flame Demon",
            "Earth Demon",
            "Frost Demon",
      ...
      ["#5 Cragheart: Stone Defense"] = {
         name = "#5 Cragheart: Stone Defense",
         monsters = {
            "Cave Bear",
            "Ooze",
            "Sun Demon",
         ...
         specials = {
            {
               ...
               name = "spawn 1",
               startOfRound = false,
               note = "One normal Cave Bear spawns at A and one elite Ooze spawns at B.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 2",
               startOfRound = false,
               note = "One normal Sun Demon spawns at C and two normal Oozes spawn at D.",
               },
            },
         },
      ["#53 Shardrender: Corrupted Presence"] = {
         name = "#53 Shardrender: Corrupted Presence",
         monsters = {
            "Deep Terror (TOA 81)",
            "Frost Demon",
            "Living Spirit",
         ...
         specials = {
               ...
               },
            {
               ...
               startOfRound = false,
               note = "Simultaneously move your character to the hex that contains your character token and move that character token to the hex you occupied.",
               },
            },
         },
      ["#48 Amber Aegis: Hive Guardian"] = {
         name = "#48 Amber Aegis: Hive Guardian",
         monsters = {
            "Flame Demon",
            "Frost Demon",
            "Wind Demon",
         ...
         specials = {
            {
               type = "Escort",
               name = "Soul Leech Egg 1",
               hp = "3+L",
               init = 25,
               },
            {
               type = "Escort",
               name = "Soul Leech Egg 2",
               hp = "3+L",
               init = 25,
               },
            {
               ...
               name = "spawn 1",
               startOfRound = true,
               note = "Spawn one normal Flame Demon at hex C.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 2",
               startOfRound = true,
               note = "Spawn two normal Sun Demons at hex D.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 3",
               startOfRound = true,
               note = "Spawn one normal Night Demon at hex B.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 4",
               startOfRound = true,
               note = "Spawn two normal Wind Demons at hex E.",
               },
            },
         },
      ["#6 Mindthief: Rodent Liberation"] = {
         name = "#6 Mindthief: Rodent Liberation",
         monsters = {
            "Vermling Scout",
            "Vermling Shaman",
            "Earth Demon (Mindthief Special)",
      ...
      ["#42 Hierophant: Archaic Preservation"] = {
         name = "#42 Hierophant: Archaic Preservation",
         monsters = {
            "Ancient Artillery",
            "Black Imp",
            "Lurker",
      ...
      ["#10 Nightshroud: Harvesting the Night"] = {
         name = "#10 Nightshroud: Harvesting the Night",
         monsters = {
            "Night Demon",
            "Deep Terror",
            },
      ...
      ["#56 Vanquisher: Return to Crystal Gardens"] = {
         name = "#56 Vanquisher: Return to Crystal Gardens",
         monsters = {
            "Shardrender (84)",
            "Smoke Spirit",
            },
      ...
      ["#28 Shattersong: Tuning the Resonance"] = {
         name = "#28 Shattersong: Tuning the Resonance",
         monsters = {
            "Algox Archer",
            "Algox Icespeaker (Shattersong Special)",
            "Chief of Spikes",
      ...
      ["#37 Bombard: Disarm the Machine"] = {
         name = "#37 Bombard: Disarm the Machine",
         monsters = {
            "Ancient Artillery",
            "Stone Golem",
            },
      ...
      ["#44 Mirefoot: A Cornered Viper"] = {
         name = "#44 Mirefoot: A Cornered Viper",
         monsters = {
            "Cave Bear",
            "Giant Viper",
            "Inox Archer",
      ...
      ["#3 Spellweaver: Corrupted Laboratory"] = {
         name = "#3 Spellweaver: Corrupted Laboratory",
         monsters = {
            "Black Imp",
            "Spitting Drake",
            "Stone Golem",
      ...
      ["#21 Blinkblade: Race Against the Clock"] = {
         name = "#21 Blinkblade: Race Against the Clock",
         monsters = {
            "Ancient Artillery (FH)",
            "Robotic Boltshooter",
            "Ruined Machine",
      ...
      ["#34 Metal Mosaic: Boiler Room"] = {
         name = "#34 Metal Mosaic: Boiler Room",
         monsters = {
            "Ancient Artillery (FH)",
            "Flaming Bladespinner",
            "Ruined Machine",
      ...
      ["#23 Deathwalker: The Dead of Night"] = {
         name = "#23 Deathwalker: The Dead of Night",
         monsters = {
            "Black Imp (Deathwalker Special)",
            "Night Demon (Deathwalker Special)",
            },
         ...
         specials = {
               ...
               },
            {
               ...
               name = "spawn 1",
               startOfRound = true,
               note = "Spawn normal Night Demon at A and D.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 2",
               startOfRound = true,
               note = "Spawn normal Black Imp at A, B, C and D.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 3",
               startOfRound = true,
               note = "Spawn elite Black Imp at A and C.",
               },
            {
               type = "Timer",
               list = {
               ...
               name = "spawn 4",
               startOfRound = true,
               note = "Spawn elite Night Demon at B and D.",
               },
            },
         },
      ["#18 Bladeswarm: The Sands of Time"] = {
         name = "#18 Bladeswarm: The Sands of Time",
         monsters = {
            "Giant Viper",
            "Living Spirit",
            "Stone Golem",
      ...
      ["#1 Brute: Return to the Black Barrow"] = {
         name = "#1 Brute: Return to the Black Barrow",
         monsters = {
            "Bandit Guard",
            "Bandit Archer",
            "Living Bones",
      ...
      ["#135 Belara's Keep"] = {
         ...
         sections = {
            ["#195.1 Belara's Keep (135)"] = {
               name = "#195.1 Belara's Keep (135)",
               monsters = {
                  "Belara",
                  },
               specials = {
      ...
      ["#65 A Strong Foundation"] = {
         ...
         sections = {
            ["#89.1 A Strong Foundation (65)"] = {
               name = "#89.1 A Strong Foundation (65)",
               monsters = {
                  "Rimeheart",
                  },
               specials = {
      ...
      ["#56 Call of the Harbinger"] = {
         ...
         sections = {
            ["#90.4 Call of the Harbinger (56)"] = {
               name = "#90.4 Call of the Harbinger (56)",
               monsters = {
                  },
               specials = {
                  {
            ...
            ["#99.4 Call of the Harbinger (56)"] = {
               name = "#99.4 Call of the Harbinger (56)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#67 Core Attunement"] = {
         ...
         specials = {
            {
               type = "Escort",
               name = "Elemental Core 1",
               hp = "4*(L+1)",
               init = 1,
               },
            {
               type = "Escort",
               name = "Elemental Core 2",
               hp = "4*(L+1)",
               init = 1,
               },
            {
               type = "Escort",
               name = "Elemental Core 3",
               hp = "4*(L+1)",
               init = 1,
               },
            {
               type = "Escort",
               name = "Elemental Core 4",
               hp = "4*(L+1)",
               init = 1,
               },
            {
      ...
      ["#72 A Giant Block of Ice"] = {
         ...
         sections = {
            ["#132.2 A Giant Block of Ice (72)"] = {
               name = "#132.2 A Giant Block of Ice (72)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#81 Ruinous Research Lab"] = {
         ...
         sections = {
            ["#174.3 Ruinous Research Lab (81)"] = {
               name = "#174.3 Ruinous Research Lab (81)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#41 Unfettered Shard"] = {
         ...
         sections = {
            ["#17.1 Unfettered Shard (41)"] = {
               name = "#17.1 Unfettered Shard (41)",
               monsters = {
                  },
               specials = {
                  {
            ...
            ["#65.2 Unfettered Shard (41)"] = {
               name = "#65.2 Unfettered Shard (41)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#54 Among the Wreckage"] = {
         ...
         sections = {
            ["#50.1 Among the Wreckage (54)"] = {
               name = "#50.1 Among the Wreckage (54)",
               monsters = {
                  },
               specials = {
                  },
      ...
      ["#105 Ruins of the Equinox"] = {
         ...
         sections = {
            ["#191.3 Ruins of the Equinox (105)"] = {
               name = "#191.3 Ruins of the Equinox (105)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#122 The Eternal Crave"] = {
         ...
         sections = {
            ["#98.1 The Eternal Crave (122)"] = {
               name = "#98.1 The Eternal Crave (122)",
               monsters = {
                  "Hungry Maw",
                  },
               specials = {
      ...
      ["#106 The Tempus Forge"] = {
         ...
         sections = {
            ["#8.1 The Tempus Forge (106)"] = {
               name = "#8.1 The Tempus Forge (106)",
               monsters = {
                  },
               specials = {
                  {
            ...
            ["#29.2 The Tempus Forge (106)"] = {
               name = "#29.2 The Tempus Forge (106)",
               monsters = {
                  "Blacksmith",
                  },
               specials = {
            ...
            ["#183.1 The Tempus Forge (106)"] = {
               name = "#183.1 The Tempus Forge (106)",
               monsters = {
                  },
               specials = {
                  {
            ...
            ["#184.4 The Tempus Forge (106)"] = {
               name = "#184.4 The Tempus Forge (106)",
               monsters = {
                  },
               specials = {
                  {
            ...
            ["#189.2 The Tempus Forge (106)"] = {
               name = "#189.2 The Tempus Forge (106)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#20 Temple of Liberation"] = {
         ...
         sections = {
            ["#14.3 Temple of Liberation (20)"] = {
               name = "#14.3 Temple of Liberation (20)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#121 Black Memories"] = {
         ...
         sections = {
            ["#115.2 Black Memories (121)"] = {
               name = "#115.2 Black Memories (121)",
               monsters = {
                  "Large Vermling Scout",
                  },
               specials = {
      ...
      ["#8 Crystal Trench"] = {
         ...
         sections = {
            ["#21.1 Crystal Trench (8)"] = {
               name = "#21.1 Crystal Trench (8)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#129 How to Lay an Ambush"] = {
         ...
         sections = {
            ["#154.2 How to Lay an Ambush (129)"] = {
               name = "#154.2 How to Lay an Ambush (129)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#86 The Lady in White"] = {
         ...
         sections = {
            ["#6.3 The Lady in White (86)"] = {
               name = "#6.3 The Lady in White (86)",
               monsters = {
                  },
               specials = {
                  {
            ...
            ["#181.4 The Lady in White (86)"] = {
               name = "#181.4 The Lady in White (86)",
               monsters = {
                  "Lady in White",
                  },
               specials = {
      ...
      ["#131 The Dancing Iceberg"] = {
         ...
         sections = {
            ["#194.2 The Dancing Iceberg (131)"] = {
               name = "#194.2 The Dancing Iceberg (131)",
               monsters = {
                  "Lurker Conductor",
                  },
               specials = {
      ...
      ["#51 Orphan's Halls"] = {
         ...
         sections = {
            ...
            ["#137.1 Orphan's Halls (51)"] = {
               name = "#137.1 Orphan's Halls (51)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#7 Edge of the World"] = {
         ...
         sections = {
            ["#48.4 Edge of the World (7)"] = {
               name = "#48.4 Edge of the World (7)",
               monsters = {
                  "Coral Corpse",
                  },
               specials = {
      ...
      ["#103 The Lead Door"] = {
         ...
         sections = {
            ["#11.7 The Lead Door (103)"] = {
               name = "#11.7 The Lead Door (103)",
               monsters = {
                  },
               specials = {
                  {
            ...
            ["#30.4 The Lead Door (103)"] = {
               name = "#30.4 The Lead Door (103)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#10 Crystal Enclosure"] = {
         ...
         sections = {
            ["#65.3 Crystal Enclosure (10)"] = {
               name = "#65.3 Crystal Enclosure (10)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#75 Infiltrating the Lair"] = {
         ...
         sections = {
            ["#167.3 Infiltrating the Lair (75)"] = {
               name = "#167.3 Infiltrating the Lair (75)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#114 Work Freeze"] = {
         ...
         sections = {
            ["#159.1 Work Freeze (114)"] = {
               name = "#159.1 Work Freeze (114)",
               monsters = {
                  },
               specials = {
                  {
         ...
         specials = {
            {
               type = "Escort",
               condition = "C<4",
               name = "Spectral Helper 1",
               hp = "2",
               note = "should spawn only 4-C helpers",
               init = 50,
               },
            {
               type = "Escort",
               condition = "C<3",
               name = "Spectral Helper 2",
               hp = "2",
               note = "should spawn only 4-C helpers",
               init = 50,
               },
         ...
         specials = {
            {
               ...
               name = "Glowing Orb",
               hp = "(L+3)*2*C",
               note = "more cabinets later on: 52.1",
               },
            },
         },
      ["#61 Life and Death"] = {
         name = "#61 Life and Death",
         monsters = {
            "Deep Terror (FH)",
            "Earth Demon (FH)",
            "Harrower Infester (FH)",
      ...
      ["#80 Relic Renewed"] = {
         ...
         specials = {
            {
               type = "Objective",
               name = "Metal Cabinet a",
               hp = "(2+L)*C/2",
               },
            {
               type = "Objective",
               name = "Metal Cabinet b",
               hp = "(2+L)*C/2",
               },
            {
               type = "Objective",
               name = "Metal Cabinet c",
               hp = "(2+L)*C/2",
               },
            {
               type = "Objective",
               name = "Metal Cabinet d",
               hp = "(2+L)*C/2",
               },
            },
         },
      ["#92 Sinking Ship"] = {
         name = "#92 Sinking Ship",
         monsters = {
            "Lightning Eel",
            "Lurker Clawcrusher",
            "Lurker Mindsnipper",
      ...
      ["#70 The True Oak"] = {
         ...
         sections = {
            ["#106.2 The True Oak (70)"] = {
               name = "#106.2 The True Oak (70)",
               monsters = {
                  "Flaming Sword of Justice",
                  },
               specials = {
      ...
      ["#55 Change of Heart"] = {
         ...
         sections = {
            ["#80.2 Change of Heart (55)"] = {
               name = "#80.2 Change of Heart (55)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#113 Lush Grotto"] = {
         ...
         sections = {
            ["#154.1 Lush Grotto (113)"] = {
               name = "#154.1 Lush Grotto (113)",
               monsters = {
                  },
               specials = {
                  },
      ...
      ["#132 Temple of Feline Power"] = {
         ...
         sections = {
            ["#110.2 Temple of Feline Power (132)"] = {
               name = "#110.2 Temple of Feline Power (132)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#37 The Dead Mile"] = {
         ...
         sections = {
            ...
            ["#81.5 The Dead Mile (37)"] = {
               name = "#81.5 The Dead Mile (37)",
               monsters = {
                  },
               specials = {
                  {
            ...
            ["#144.1 The Dead Mile (37)"] = {
               name = "#144.1 The Dead Mile (37)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#45 Living Glacier"] = {
         ...
         sections = {
            ["#85.2 Living Glacier (45)"] = {
               name = "#85.2 Living Glacier (45)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#101 Harrower Library"] = {
         ...
         sections = {
            ["#126.2 Harrower Library (101)"] = {
               name = "#126.2 Harrower Library (101)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#116 Caravan Guards"] = {
         ...
         specials = {
            ...
            {
               type = "Escort",
               name = "Caravan Wagon 1",
               hp = "C*2+L",
               init = 50,
               },
            {
               type = "Escort",
               name = "Caravan Wagon 2",
               hp = "C*2+L",
               init = 50,
               },
            {
               type = "Escort",
               name = "Caravan Wagon 3",
               hp = "C*2+L",
               init = 50,
               },
            {
               type = "Escort",
               name = "Caravan Wagon 4",
               hp = "C*2+L",
               init = 50,
               },
            {
               type = "Escort",
               name = "Caravan Wagon 5",
               hp = "C*2+L",
               init = 50,
               },
            },
      ...
      ["#27 Depths of Delirium"] = {
         ...
         sections = {
            ["#95.1 Depths of Delirium (27)"] = {
               name = "#95.1 Depths of Delirium (27)",
               monsters = {
                  },
               specials = {
                  {
            ...
            ["#68.3 Depths of Delirium (27)"] = {
               name = "#68.3 Depths of Delirium (27)",
               monsters = {
                  },
               specials = {
                  {
            ...
            ["#69.2 Depths of Delirium (27)"] = {
               name = "#69.2 Depths of Delirium (27)",
               monsters = {
                  },
               specials = {
                  {
            ...
            ["#148.4 Depths of Delirium (27)"] = {
               name = "#148.4 Depths of Delirium (27)",
               monsters = {
                  },
               specials = {
                  {
            ...
            ["#71.5 Depths of Delirium (27)"] = {
               name = "#71.5 Depths of Delirium (27)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#120 Under the Influence"] = {
         ...
         sections = {
            ["#101.1 Under the Influence (120)"] = {
               name = "#101.1 Under the Influence (120)",
               monsters = {
                  },
               specials = {
                  {
            ...
            ["#157.1 Orphan's Halls (120)"] = {
               name = "#157.1 Orphan's Halls (120)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#109 Furious Factory"] = {
         ...
         sections = {
            ["#195.2 Furious Factory (109)"] = {
               name = "#195.2 Furious Factory (109)",
               monsters = {
                  "Laser Spire Controller",
                  },
               specials = {
            ...
            ["#162.1 Furious Factory (109)"] = {
               name = "#162.1 Furious Factory (109)",
               monsters = {
                  },
               specials = {
                  {
                     type = "Objective",
                     name = "Metal Cabinet 1",
                     hp = "(2+L)*C/2",
                     },
                  },
               },
            ["#166.3 Furious Factory (109)"] = {
               name = "#166.3 Furious Factory (109)",
               monsters = {
                  },
               specials = {
                  {
                     type = "Objective",
                     name = "Metal Cabinet 2",
                     hp = "(2+L)*C/2",
                     },
                  },
               },
            ["#172.5 Furious Factory (109)"] = {
               name = "#172.5 Furious Factory (109)",
               monsters = {
                  },
               specials = {
                  {
                     type = "Objective",
                     name = "Metal Cabinet 3",
                     hp = "(2+L)*C/2",
                     },
                  },
               },
            ["#186.2 Furious Factory (109)"] = {
               name = "#186.2 Furious Factory (109)",
               monsters = {
                  },
               specials = {
                  {
                     type = "Objective",
                     name = "Metal Cabinet 4",
                     hp = "(2+L)*C/2",
                     },
                  },
               },
      ...
      ["#104 Ruins of the Solstice"] = {
         ...
         sections = {
            ["#14.2 Ruins of the Solstice (104)"] = {
               name = "#14.2 Ruins of the Solstice (104)",
               monsters = {
                  },
               specials = {
                  },
      ...
      ["#89 A Contained Fire"] = {
         ...
         sections = {
            ["#36.1 A Contained Fire (89)"] = {
               name = "#36.1 A Contained Fire (89)",
               monsters = {
                  },
               specials = {
                  {
            ...
            ["#119.2 A Contained Fire (89)"] = {
               name = "#119.2 A Contained Fire (89)",
               monsters = {
                  },
               specials = {
                  {
            ...
            ["#146.3 A Contained Fire (89)"] = {
               name = "#146.3 A Contained Fire (89)",
               monsters = {
                  "Vanjal",
                  },
               specials = {
      ...
      ["#96 Underground Station"] = {
         ...
         sections = {
            ["#18.1 Underground Station (96)"] = {
               name = "#18.1 Underground Station (96)",
               monsters = {
                  },
               specials = {
                  {
            ...
            ["#116.2 Underground Station (96)"] = {
               name = "#116.2 Underground Station (96)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#43 Overrun Barricade"] = {
         ...
         sections = {
            ["#2.3 Overrun Barricade (43)"] = {
               name = "#2.3 Overrun Barricade (43)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#88 Collection's Capstone"] = {
         ...
         sections = {
            ["#25.1 Collection’s Capstone (88)"] = {
               name = "#25.1 Collection’s Capstone (88)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#71 Invasion of the Dock"] = {
         ...
         sections = {
            ["#111.2 Invasion of the Dock (71)"] = {
               name = "#111.2 Invasion of the Dock (71)",
               monsters = {
                  },
               specials = {
                  {
      ...
      ["#21 Realm of Endless Frost"] = {
         name = "#21 Realm of Endless Frost",
         monsters = {
            "Prince of Frost",
            "Frost Demon (FH)",
            "Living Bones (FH)",
         ...
         sections = {
            ["#48.1 Realm of Endless Frost (21)"] = {
               name = "#48.1 Realm of Endless Frost (21)",
               monsters = {
                  },
               specials = {
                  {
            ...
            ["#51.1 Realm of Endless Frost (21)"] = {
               name = "#51.1 Realm of Endless Frost (21)",
               monsters = {
                  },
               specials = {
                  {
         ...
         sections = {
            ["#52.1 Dead Pass (44)"] = {
               ...
               specials = {
                  ...
                  {
                     type = "Objective",
                     name = "Metal Cabinet 5",
                     hp = "C*(L+3)/2",
                     },
                  },
               },
            ["#149.1 Dead Pass (44)"] = {
               name = "#149.1 Dead Pass (44)",
               monsters = {
                  },
               specials = {
                  {
                     type = "Objective",
                     name = "Metal Cabinet 6",
                     hp = "C*(L+3)/2",
                     },
                  },
               },
